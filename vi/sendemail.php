<?php
    ...
    $to         = 'catdang94.it@gmail.com@gmail.com';  // put your email here
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'<strong>Cảm ơn!</strong>&nbsp; Email của bạn đã được gửi.' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'<strong>Lỗi!</strong>&nbsp; Không thể gửi mail'  );
    }
